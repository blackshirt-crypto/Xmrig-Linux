...
wget https://raw.githubusercontent.com/blackshirt-crypto/Xmrig-Linux/main/xmrig-linux-setup.sh
...
```bash
bash <(curl -s https://raw.githubusercontent.com/blackshirt-crypto/Xmrig-Linux/main/xmrig-linux-setup.sh)
```
